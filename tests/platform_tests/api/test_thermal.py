...
class TestThermalApi(PlatformApiTestBase):
    ...
    def test_get_position_in_parent(self, platform_api_conn):
        for i in range(self.num_thermals):
            ...
            self.expect(position is not None, "Failed to perform get_position_in_parent for thermal {}".format(i))
    ...
    def test_is_replaceable(self, platform_api_conn):
        for i in range(self.num_thermals):
            ...
            self.expect(replaceable is not None, "Failed to perform is_replaceable for thermal {}".format(i))
